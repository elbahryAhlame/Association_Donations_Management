...
//recuperation des donnes 
  var xhr = getXhr();
    xhr.open("POST", "AffichageDonnateur.php", true);
    xhr.send();
        ...
        try {
          ...
          for(var i =0; i<tab.length;i++)
          {
           ...
           tr= document.createElement("tr");
            ...
            th1.innerHTML=tab[i].Nom;
            th2.innerHTML=tab[i].Prenom;
            th3.innerHTML=tab[i].email;
            th4.innerHTML=tab[i].adresse;
            th5.innerHTML=tab[i].telephone;
